...
public class MediSearchCatoTM {
    ...
    public MediSearchCatoTM() {
    }

    public MediSearchCatoTM(String catogoryID, String mediID, String mediName, String mediUseDescription, String catogoryName) {
